      ...
      <section className="terms-section container-fluid">
        <div className="container terms-wrapper" data-aos="fade-up">
          ...
          <div className="terms-content text-white">
            <h3 className="terms-heading mt-5">1.&nbsp;Summary</h3>
            <ul>
              <li>
                <p>
            ...
            <h3 className="terms-heading mt-5">2.&nbsp;What’s Eligible</h3>
            ...
            <h3 className="terms-heading mt-5">3.&nbsp;Not Eligible</h3>
            ...
            <h3 className="terms-heading mt-5">4.&nbsp;How to Request a Refund</h3>
            <ul>
              <li>
            ...
            <h3 className="terms-heading mt-5">5.&nbsp;Cancellations</h3>
            <p>
            ...
            <h3 className="terms-heading mt-5">6.&nbsp;Chargebacks & Disputes</h3>
            <p>
