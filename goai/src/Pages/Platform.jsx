      ...
      <section className="platform-features platform-container">
        <div data-aos="fade-up">
          ...
          <p className="payment-subtext">
            ...
            intelligent automation, real-time insights, and powerful decision
            tools.
          </p>
        </div>
        <div className="features-grid">
          ...
          <div className="feature-card" data-aos="fade-up">
            ...
            <p className="feature-text">
              Monitor trends, track performance, and access live data that helps
              you stay ahead in every situation.
            </p>
          </div>
          ...
          <div className="feature-card" data-aos="fade-up">
            ...
            <p className="feature-text">
              Enterprise-level security ensures your data, decisions, and wealth
          ...
          <div className="feature-card" data-aos="fade-up">
            ...
            <p className="feature-text">
              Scalable systems that connect thousands of users across regions to
